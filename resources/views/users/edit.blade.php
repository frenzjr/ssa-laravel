                ...
                <div class="card-body">
                    <form method="POST" enctype=multipart/form-data>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="suffixname" type="text" class="form-control @error('suffixname') is-invalid @enderror" name="suffixname" value="{{ old('suffixname')  ?? $user->suffixname }}" required autocomplete="suffixname" {{!is_null($user->deleted_at) ? 'disabled' : ''}}>
