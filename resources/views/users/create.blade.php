                ...
                <div class="card-body">
                    <form method="POST" enctype=multipart/form-data>
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Prefix') }}</label>

                            <div class="col-md-6">
                                <select name="prefixname" class="form-control @error('prefixname') is-invalid @enderror">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="photo" type="file" class="form-control @error('photo') is-invalid @enderror" name="photo" value="{{ old('photo') }}" accept="image/*">
